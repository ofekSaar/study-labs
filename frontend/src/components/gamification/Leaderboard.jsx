...
const Leaderboard = ({ courseId }) => {
    ...
    return (
        <div
            className="glass-card rounded-3xl p-3 sm:p-5 relative overflow-hidden group h-full flex flex-col"
            dir="rtl"
        >
                        ...
                        entries.map((entry, i) => {
                              ...
                              return (
                                  ...
                                  >
                                      {/* Rank badge / Medal */}
                                      <div
                                          className={`w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0 text-xs font-black border-b-2 shadow-sm transition-all duration-300 ${
                                              rankStyle
                                      ...
                                      {/* Name */}
                                      <span
                                          className={`text-xs font-extrabold flex-1 truncate ${
                                              entry.isYou
