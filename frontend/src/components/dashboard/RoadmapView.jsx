...
const TypeBadge = ({ type }) => {
    ...
    return (
        <span
            className={`inline-flex items-center gap-1 ${cfg.bg} ${cfg.color} ${cfg.border} border px-2 py-0.5 rounded-md text-[10px] font-black`}
        >
        ...
        >
            ...
            <div className="relative p-5">
                <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="text-[10px] font-bold text-orange-100/50">
                        Step {index + 1}
                    </span>
                </div>
...
const MilestoneMarker = ({ number, allComplete }) => (
    ...
    >
        ...
        <div
            className={`flex items-center gap-1.5 px-3 py-1 rounded-full border text-[10px] font-black whitespace-nowrap ${
                allComplete
...
const ExpandedPanel = ({ node, nodesUntilCurrent, onStart }) => {
    ...
    const quizPct =
        isCompleted && node.quizScore?.totalAnswerable > 0
    ...
    return (
        ...
        >
            <div
                className={`mb-2 px-4 py-3 rounded-b-2xl border border-t-0 ${
                    isLocked
                    ...
                    <div className="space-y-2.5">
                        <div className="flex items-center gap-3 flex-wrap">
                            <span className="inline-flex items-center gap-1 text-sm font-black text-orange-500 dark:text-orange-400">
                                <Zap size={13} strokeWidth={2.5} />+{node.xpReward || 150} XP
                            </span>
                            ...
                            {quizPct !== null && (
                                <>
                                    ...
                                    <span
                                        className={`inline-flex items-center gap-1 text-xs font-black ${quizPct >= 70 ? 'text-emerald-500 dark:text-emerald-400' : 'text-red-400'}`}
                                    >
                                        <Star
                                            size={11}
                                            className={
        ...
        return (
            <div className="p-12 text-center">
                ...
                <p className="text-slate-400 dark:text-white/40 font-medium">
                    Select a course to view your learning path
                </p>
            </div>
        );
            ...
            <div className="space-y-0 pb-4">
                <AnimatePresence initial={false}>
                    {nodes.map((node, index) => {
                        ...
                        const nodesUntilCurrent =
                            isLocked && currentNodeIndex >= 0 ? index - currentNodeIndex : 0;
                        ...
                        const checkpointAllComplete = showCheckpoint
                            ? nodes
                                  .slice(index - CHECKPOINT_EVERY, index)
                            ...
                            <React.Fragment key={nodeId}>
                                {showCheckpoint && (
                                    <MilestoneMarker
                                        ...
                                        allComplete={checkpointAllComplete}
                                    />
                                )}
                                ...
                                >
                                    <div className="flex gap-3 items-stretch">
                                        ...
                                        <div className="flex flex-col items-center flex-shrink-0 w-10">
                                            <div
                                                className={`w-0.5 flex-1 min-h-[10px] transition-colors duration-500 ${lineTop}`}
                                            />
                                            ...
                                            <div
                                                className={`w-0.5 flex-1 min-h-[10px] transition-colors duration-500 ${lineBottom}`}
                                            />
                                        </div>
                                            ...
                                            >
                                                ...
                                                <div className="min-w-0 flex-1 pl-1">
                                                    <div className="flex items-center gap-1.5 mb-0.5">
                                                        ...
                                                        <span className="text-slate-300 dark:text-white/10 text-[10px]">
                                                            ·
                                                        </span>
                                                        <TypeBadge type={node.type} />
                                                    </div>
                                                    <h4
                                                        className={`text-sm font-extrabold leading-snug truncate transition-colors ${
                                                            isLocked
