        ...
        <div className="h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
                <BarChart data={data} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                    <CartesianGrid strokeDasharray="3 3" vertical={false} stroke={isDark ? 'rgba(255,255,255,0.05)' : 'rgba(15,23,42,0.06)'} />
                    <XAxis
                        dataKey="name"
                        axisLine={false}
                        tickLine={false}
                        tick={{ fontSize: 12, fill: isDark ? 'rgba(255,255,255,0.6)' : 'rgba(15,23,42,0.6)' }}
                        dy={10}
                        angle={-45}
                        textAnchor="end"
                        height={80}
                    ...
                    <YAxis
                        ...
                        tickLine={false}
                        tick={{ fontSize: 12, fill: isDark ? 'rgba(255,255,255,0.6)' : 'rgba(15,23,42,0.6)' }}
                        label={{ value: 'Students', angle: -90, position: 'insideLeft', style: { fontSize: 12, fill: isDark ? 'rgba(255,255,255,0.4)' : 'rgba(15,23,42,0.5)' } }}
                    />
                    <Tooltip
