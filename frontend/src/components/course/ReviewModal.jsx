        ...
        >
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
                ...
                <div className="flex flex-col items-center gap-2">
                    ...
                    <p
                        className={`text-sm font-black transition-all duration-200 ${rating ? 'text-amber-500' : 'text-slate-400 dark:text-white/30'}`}
                    >
                ...
                <div>
                    <label
                        ...
                        className="text-[11px] font-black uppercase tracking-widest text-slate-400 dark:text-white/30 mb-2 block"
                    >
                        Comment (optional)
                    </label>
                    <textarea
                    ...
                    />
                    <p className="text-[10px] text-slate-400 dark:text-white/25 text-right mt-1">
                        {comment.length}/500
                    </p>
                </div>
