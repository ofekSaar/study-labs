    ...
    return (
        ...
        >
            ...
            <div className="space-y-3 mb-5">
                ...
                />
                <span className="flex items-center gap-2 select-none text-sm font-semibold text-slate-600 dark:text-white/60">
                    <button
                        type="button"
                    ...
                    >
                        <span
                            className={`w-4 h-4 rounded-full bg-white shadow transition-transform ${isPinned ? 'translate-x-4' : 'translate-x-0'}`}
                        />
                    </button>
                        ...
                        >
                            <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-1.5 mb-0.5">
                                    {ann.isPinned && (
                                        <Pin size={11} className="text-indigo-500 shrink-0" />
                                    )}
