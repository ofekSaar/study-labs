...
export const BADGES = [
    ...
    // ── Speed & skill ─────────────────────────────────────────────────
    {
        id: 'speed_demon',
        name: 'Speed Demon',
        description: 'Answer a question in under 5s',
        icon: '⚡',
        rarity: 'uncommon',
        condition: 'fast_answers',
        threshold: 1,
    },
    {
        id: 'no_mistakes_5',
        name: 'Flawless',
        description: 'Answer 5 questions without error',
        icon: '🛡️',
        rarity: 'uncommon',
        condition: 'no_mistake_streak',
        threshold: 5,
    },
    {
        id: 'triple_perfect',
