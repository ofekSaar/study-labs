...
function StatCard({ icon, label, value, sub, accent = 'blue', progress, highlight }) {
    ...
    return (
        <div
            className={`relative bg-white border rounded-2xl p-5 flex flex-col gap-3 overflow-hidden transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5 ${a.border} ${highlight ? `shadow-md ${a.glow}` : 'border-slate-100 shadow-sm'}`}
        >
            {/* top accent line */}
...
function HeroBanner({ generation, enrollments, engagement }) {
    const xp =
        generation.readyCourses * 200 +
        enrollments.totalStudents * 50 +
        (engagement.avgCompletionRate ?? 0);
                ...
                <div className="flex sm:flex-col gap-3 sm:gap-2 flex-shrink-0">
                    <div className="flex items-center gap-2 bg-white/10 rounded-xl px-3 py-2">
                        ...
                        <span className="text-sm font-bold text-white">
                            {generation.readyCourses} courses
                        </span>
                    </div>
                    <div className="flex items-center gap-2 bg-white/10 rounded-xl px-3 py-2">
                        <Users size={14} className="text-blue-300" />
                        <span className="text-sm font-bold text-white">
                            {enrollments.totalStudents} students
                        </span>
                    </div>
                </div>
            </div>
    ...
    return (
        <>
            <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
                ...
                {data &&
                    (() => {
                        const { generation, enrollments, content, engagement, recentCourses } =
                            data;
                        return (
                            <>
                                <HeroBanner
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                    ...
                                    <StatCard
                                        ...
                                        label="Success Rate"
                                        value={
                                            generation.totalCourses > 0
                                                ? `${generation.successRate}%`
                                                : '—'
                                        }
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                    ...
                                    <StatCard
                                        ...
                                        label="Approval Rate"
                                        value={
                                            enrollments.approvalRate != null
                                                ? `${enrollments.approvalRate}%`
                                                : '—'
                                        }
                                    ...
                                    <StatCard
                                        ...
                                        value={
                                            engagement.avgCompletionRate != null
                                                ...
                                                <thead>
                                                    <tr className="bg-slate-50 border-b border-slate-100">
                                                        {[
                                                            ...
                                                            <th
                                                                key={h}
                                                                className="px-4 py-3 text-left text-[10px] font-black text-slate-400 uppercase tracking-widest"
                                                            >
                                                                {h}
                                                            </th>
                                                        ))}
                                                    ...
                                                    {recentCourses.map((course) => {
                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                ...
                                                                <td className="px-4 py-3.5">
                                                                    <span
                                                                        className={`text-[10px] font-black uppercase px-2.5 py-1 rounded-full border ${STATUS_STYLES[course.generationStatus]}`}
                                                                    >
                                                                        {STATUS_LABELS[
