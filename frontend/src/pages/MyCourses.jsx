                        ...
                        {enrolledCourses.map(course => (
                            ...
                            >
                                ...
                                <div className="flex justify-between items-start mb-6 relative z-10">
                                    <div className={`w-14 h-14 rounded-2xl flex items-center justify-center shadow-inner border border-slate-200 dark:border-white/10 ${course.color || 'bg-indigo-500/20 text-indigo-400'}`}>
