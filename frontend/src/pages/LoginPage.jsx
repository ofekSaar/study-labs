...
const XPBubble = ({ value, style }) => (
    <div
        className="absolute pointer-events-none font-bold text-sm rounded-full px-3 py-1"
        style={{
...
const RoadmapNode = ({ x, y, color, icon, delay, size = 44 }) => (
    <g>
        ...
        <text x={x} y={y + 6} textAnchor="middle" fontSize="16" fill="white">
            {icon}
        </text>
    </g>
);
...
const LoginPage = () => {
    ...
    return (
        ...
        >
            ...
            <XPBubble
                value="Level Up! 🚀"
                style={{ top: '14%', left: '11%', animationDelay: '4s' }}
            />
            <XPBubble
                value="+25 XP"
                style={{ bottom: '14%', right: '11%', animationDelay: '1.5s' }}
            />
            ...
            <div className="relative z-10 w-full max-w-md mx-4 page-enter">
                <div
                    ...
                    style={{
                        ...
                        boxShadow:
                            '0 30px 70px rgba(0,0,0,0.55), inset 0 1px 0 rgba(255,255,255,0.08)',
                    }}
                >
                    {/* Player badge */}
                    ...
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <span className="font-display font-black text-2xl text-white mb-2">
                            StudyLabs
                        </span>
                        <h2
                            className="text-xl font-black"
                            style={{
                                background: 'linear-gradient(90deg, #F59E0B, #D97757, #EC4899)',
