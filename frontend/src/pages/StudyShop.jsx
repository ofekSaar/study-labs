...
import { Coins, ShoppingBag, Lock, Check, Sparkles, HelpCircle, Zap, Shield } from 'lucide-react';
            ...
            <div className="max-w-6xl mx-auto px-4 py-4 sm:py-8 space-y-8 pb-24">
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-3xl font-black text-amber-400 mt-1.5 font-display">{coins ?? 0} Coins</p>
                            </div>
                        </motion.div>
                    </div>
                </motion.div>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {isOwned ? (
                                            ...
                                            <button
                                                onClick={() => buyItem('avatars', item.id, item.cost)}
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {isOwned ? (
                                            ...
                                            <button
                                                onClick={() => buyItem('titles', item.id, item.cost)}
                                                className="bg-amber-500 hover:bg-amber-600 active:scale-95 text-slate-950 font-black text-xs px-4 py-2 rounded-xl flex items-center gap-1 transition shadow-sm shrink-0"
                                            >
                                                🪙 {item.cost}
                                            </button>
                            ...
                            {SHOP_ITEMS.powerups.map(item => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <button
                                            onClick={() => buyItem('powerups', item.id, item.cost)}
                                            className="bg-amber-500 hover:bg-amber-600 active:scale-95 text-slate-950 font-black text-xs px-4 py-2 rounded-xl flex items-center gap-1 transition shadow-sm shrink-0"
                                        >
                                            🪙 {item.cost}
                                        </button>
                ...
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-10">
                        ...
                        <div className="bg-slate-50/50 dark:bg-black/25 rounded-2xl p-4 border border-slate-200/50 dark:border-white/5">
                            <div className="w-10 h-10 rounded-xl bg-orange-500/10 text-orange-600 dark:text-orange-400 flex items-center justify-center font-black mb-3">
                                🔥
                            </div>
                        ...
                        <div className="bg-slate-50/50 dark:bg-black/25 rounded-2xl p-4 border border-slate-200/50 dark:border-white/5">
                            <div className="w-10 h-10 rounded-xl bg-purple-500/10 text-purple-600 dark:text-purple-400 flex items-center justify-center font-black mb-3">
                                👑
                            </div>
