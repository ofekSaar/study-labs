...
export const QUEST_DEFINITIONS = {
    daily: [
        ...
        },
        {
            ...
            title: 'Speed Bonus: Answer in under 5s',
            action: 'speed_bonus',
            target: 1,
            xp: 150,
            icon: '⚡',
    ...
    weekly: [
        ...
        {
            id: 'weekly_perfect_quizzes',
            title: 'Score 100% on 3 quizzes',
            action: 'perfect_quiz',
            target: 3,
            xp: 600,
            icon: '💎',
    ...
    milestone: [
        ...
        {
            id: 'milestone_lessons_25',
            title: 'Complete 25 lessons total',
            action: 'complete_lesson',
            target: 25,
            xp: 800,
            icon: '🏆',
        ...
        {
            id: 'milestone_perfect_quizzes_10',
            title: 'Get 10 perfect quizzes',
            action: 'perfect_quiz',
            target: 10,
            xp: 1200,
            icon: '🥇',
    ...
    avatars: [
        {
            ...
            name: 'Wizard Scholar',
            cost: 150,
            description: 'A mystical master of educational wisdom.',
            rarity: 'rare',
        ...
        },
        {
            ...
            name: 'Cyber Learner',
            cost: 250,
            description: 'Direct neural interface to the study database.',
            rarity: 'epic',
            previewColors: ['#06b6d4', '#3b82f6'],
        },
        {
            id: 'unicorn_scholar',
            emoji: '🦄',
            name: 'Academic Unicorn',
            cost: 400,
            description: 'A rare creature of unparalleled brilliance.',
            rarity: 'legendary',
            previewColors: ['#ec4899', '#f59e0b'],
            isNew: true,
        },
    ],
    titles: [
        {
            id: 'knowledge_alchemist',
            name: 'Alchemist of Knowledge',
            cost: 100,
            description: 'Transmuting study time into pure genius.',
            rarity: 'common',
        ...
        },
        {
            ...
            name: 'Ultimate Mind',
            cost: 200,
            description: 'Capable of storing infinite amounts of material.',
            rarity: 'rare',
            previewColors: ['#6366f1', '#8b5cf6'],
        },
        {
            ...
            cost: 350,
            description: 'Your achievements will be spoken of for generations.',
            rarity: 'legendary',
    ...
    themes: [
        {
            ...
            cost: 200,
            description: 'Pixelated aesthetics and green phosphorescent fonts.',
            rarity: 'rare',
            previewColors: ['#10b981', '#065f46'],
            swatchColors: ['#0f172a', '#10b981', '#065f46', '#d1fae5'],
        },
        {
            id: 'space',
            emoji: '🌌',
            name: 'Space Nebula Theme',
            cost: 350,
            description: 'Deep space cosmic background with star constellations.',
            rarity: 'epic',
            previewColors: ['#6366f1', '#0f172a'],
            swatchColors: ['#0f172a', '#6366f1', '#8b5cf6', '#e0e7ff'],
        },
        {
            id: 'cyberpunk',
            emoji: '🤖',
            ...
            cost: 500,
            description: 'Cybernetic neon styles with glitch and sharp clip designs.',
            rarity: 'legendary',
            previewColors: ['#ec4899', '#0f172a'],
            swatchColors: ['#0f172a', '#ec4899', '#06b6d4', '#f0abfc'],
            isNew: true,
        },
    ],
    frames: [
        {
            id: 'bronze',
            emoji: '🟫',
            name: 'Bronze Glow Frame',
            cost: 100,
            description: 'Covers your avatar in a warm bronze glow.',
            rarity: 'common',
            glowColor: '#92400e',
        },
        {
            id: 'silver',
            emoji: '⬜',
            name: 'Silver Glow Frame',
            cost: 180,
            description: 'Sleek silver futuristic border.',
            rarity: 'rare',
            glowColor: '#94a3b8',
        },
        {
            id: 'gold',
            emoji: '🟨',
            name: 'Gold Shine Frame',
            cost: 300,
            description: 'Bright glowing gold frame.',
            rarity: 'epic',
            glowColor: '#f59e0b',
        },
        {
            id: 'diamond',
            emoji: '💎',
            name: 'Diamond Sparkle Frame',
            cost: 500,
            description: 'Exclusive diamond border that sparkles and shifts colors.',
            rarity: 'legendary',
            glowColor: '#06b6d4',
            isNew: true,
        },
    ...
    powerups: [
        {
            ...
            rarity: 'common',
            previewColors: ['#10b981', '#065f46'],
            effect: 'Protects your daily study streak for 1 missed day.',
        },
        {
            id: 'xp_boost',
            emoji: '⚡',
            name: 'XP Boost Token (2x)',
            cost: 120,
            description: 'Doubles all XP earned from your next quiz.',
            rarity: 'rare',
            previewColors: ['#f59e0b', '#92400e'],
            effect: 'Doubles XP earned on your very next quiz submission.',
        },
        {
            id: 'weekend_freeze',
            emoji: '🥶',
            name: 'Weekend Freeze',
            cost: 150,
            description: 'Freezes your streak during the weekend.',
            rarity: 'rare',
            previewColors: ['#06b6d4', '#1e3a5f'],
            effect: 'Pauses streak decay on Saturday and Sunday.',
        },
    ],
};
